...
```{r apsorption, fig.cap='Normalized absorption of red, green and blue dye solutions. Compare these data with your own results.', echo=FALSE, message=FALSE, warning=FALSE}
	knitr::include_graphics("./figures/photosynthesis/absorption_result.jpg")
```
