...
knitr::include_graphics("./figures/photosynthesis/photosynthesis.png")
```
...
4.  Place a beaker of water between the plant and the light to prevent overheating the plant. Allow the system to stand 7-10 minutes, or until bubbles begin to appear regularly.
...
```{r spectrophotometer, fig.cap='Spectrophotometer and cuvettes with dye solutions.', echo=FALSE, message=FALSE, warning=FALSE}
	knitr::include_graphics("./figures/photosynthesis/spectrophotometer.png")
```
...
6.  Follow the instructions posted on the spectrophotometer.
...
9.  Compare your curves with the color spectrum shown in Figure \@ref(fig:spectrum).

```{r cuvettes, fig.cap='Cuvettes placed in the spectrophotometer.', echo=FALSE, message=FALSE, warning=FALSE}
	knitr::include_graphics("./figures/photosynthesis/cuvettes.png")
```
...
```{r chromatography, fig.height='3', fig.cap='Result of the Chromatography experiment.', echo=FALSE, message=FALSE, warning=FALSE}
	knitr::include_graphics("./figures/photosynthesis/chromatography.png")
```
