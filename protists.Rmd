...
knitr::include_graphics("./figures/protists/Amoeba_proteus.png")
```
...
knitr::include_graphics("./figures/protists/Paramecium_caudatum.png")
```
...
knitr::include_graphics("./figures/protists/euglena.png")
```
...
knitr::include_graphics("./figures/protists/peranema.png")
```
...
knitr::include_graphics("./figures/protists/chlamydomonas_live.png")
```
...
knitr::include_graphics("./figures/protists/Pandorina.png")
```
...
knitr::include_graphics("./figures/protists/Volvox.png")
```
...
knitr::include_graphics("./figures/protists/oedogonium.png")
```
...
knitr::include_graphics("./figures/protists/Spirogyra.png")
```
##  View Prepared Slides
###	Amoeba proteus

###	Paramecium 4 types of protista
...
knitr::include_graphics("./figures/protists/paramecium_conjugation.png")
```
...
knitr::include_graphics("./figures/protists/ceratium.png")
```
...
knitr::include_graphics("./figures/protists/foraminifera.png")
```
...
knitr::include_graphics("./figures/protists/radiolaria.png")
```
...
knitr::include_graphics("./figures/protists/diatomes.png")
```
...
knitr::include_graphics("./figures/protists/volvox_sex.png")
```

###	Spirogyra

###	Oedogonium zygospores

###	Oedogonium macrandous
...
knitr::include_graphics("./figures/protists/male_fucus.png")
```
...
knitr::include_graphics("./figures/protists/female_fucus.png")
```

###	*Polysiphonia*
[*Polysiphonia*](https://en.wikipedia.org/wiki/Polysiphonia) is a genus of filamentous red algae with about 19 species on the coasts of the British Isles and about 200 species worldwide.
...
knitr::include_graphics("./figures/protists/stemonitis.png")
```
...
knitr::include_graphics("./figures/protists/saprolegnia.png")
```
