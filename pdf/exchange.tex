...
{\centering \includegraphics[width=0.4\linewidth]{./figures/exchange/liquid_diffusion} 
...
{\centering \includegraphics[width=0.4\linewidth]{./figures/exchange/solid_diffusion} 
...
\item
  ...
  blood and saline.
\item
  Place each slide on the stage of each of three microscopes that are side by
  side.
\item
...
\caption{Red blood cells from sheep in hypertonic saline
solution (5\% NaCl).}\label{fig:hypertonic}
\end{figure}
...
\caption{Red blood cells from sheep in isotonic saline solution (0.85\% NaCl).}\label{fig:isotonic}
\end{figure}
...
\caption{Elodea leaf in hypertonic saline solution (7\%
NaCl).}\label{fig:plasmolysis}
\end{figure}
