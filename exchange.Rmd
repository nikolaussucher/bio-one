...
4. From time to time, observe the how the KMnO~4~ diffuses through the water (Figure \@ref(fig:liquid)).
...
2. Place a few crystals of malachite green about 2 centimeters from the potassium permanganate crystal (Figure \@ref(fig:solid)).
...
12. When starch molecules touch iodine, a blue or purplish color appears (Figure \@ref(fig:dialysis)).
...
Now watch a [time lapse video](https://www.youtube.com/kp9EvMeTMUs) of this experiment:

<iframe width="560" height="315" src="https://www.youtube.com/embed/kp9EvMeTMUs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
Now watch a [video](https://www.youtube.com/siqlXuFo4To) of what you would see using the microscope in this experiment:

<iframe width="560" height="315" src="https://www.youtube.com/embed/siqlXuFo4To" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
7. Place each slide on the stage of each of three microscopes that are side by side.
7. Using the 4× objective, focus on the blood and choose an area where the cells are thinly distributed.
8. Switch  to the to 10× objective. Refocus on the blood using the fine focus knob. Then switch to the 40× objective, refocus using the fine focus knob and observe the blood cells under 400× magnification.
8. Compare your observation with Figure \@ref(fig:hypertonic), Figure \@ref(fig:isotonic) and Figure \@ref(fig:hypotonic).
...
Now watch a [video](https://www.youtube.com/A8cI6FkcG4c) of the results of this experiment:

<iframe width="560" height="315" src="https://www.youtube.com/embed/A8cI6FkcG4c" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
Now watch a [video](https://www.youtube.com/embed/zVvHn6Sj9PQ) of the results of this experiment:

<iframe width="560" height="315" src="https://www.youtube.com/embed/zVvHn6Sj9PQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
3. Let it sit for a minute or two and observe again. The cell contains a vacuole, which holds most of the cell's water, similar to a water bag inside the cell. Note the clear space forming between the cell wall and the cell membrane (Figure \@ref(fig:plasmolysis)).
