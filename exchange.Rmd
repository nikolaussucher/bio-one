...
knitr::include_graphics("./figures/exchange/Dialysis.png")
```
...
knitr::include_graphics("./figures/exchange/Osmosis_blood.png")
```
...
knitr::include_graphics("./figures/exchange/Osmosis_plant.png")
```
