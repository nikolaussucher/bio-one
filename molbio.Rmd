...
knitr::include_graphics("./figures/molbio/Gel_box.png")
```
...
knitr::include_graphics("./figures/molbio/Power_supply.png")
```
...
knitr::include_graphics("./figures/molbio/Gel_doc.png")
```
