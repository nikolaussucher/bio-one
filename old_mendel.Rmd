...
knitr::include_graphics("./figures/mendel/Monohybrid_cross.png")
```
...
[Dihybrid cross](https://en.wikipedia.org/wiki/Dihybrid_cross) is a cross between two different lines (varieties, strains) that differ in two observed traits. In the name "Dihybrid cross", the "di" indicates that there are two traits involved (e.g. R and Su), the "hybrid" means that each trait has two different alleles (e.g. R and r, or Su and su), and "cross" means that there are two individuals who are combining or "crossing" their genetic information.
...
knitr::include_graphics("./figures/mendel/blood_typing.png")
```
