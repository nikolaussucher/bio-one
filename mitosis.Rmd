...
knitr::include_graphics("./figures/mitosis/Onion_root_tip.png")
```
...
knitr::include_graphics("./figures/mitosis/Fish_blastodisc.png")
```
...
knitr::include_graphics("./figures/mitosis/Onion_root_tip_spread.png")
```
